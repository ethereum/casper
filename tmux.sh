...
tmux send-keys -t simplecasper:0.0 simplecasper\ -l\ :debug\ run\ 0 C-m

tmux splitw -t simplecasper:0
tmux select-layout -t simplecasper:0 tiled
tmux send-keys -t simplecasper:0.1 source\ \~/.zshrc C-m
tmux send-keys -t simplecasper:0.1 simplecasper\ -l\ :debug\ run\ 1 C-m

tmux splitw -t simplecasper:0
tmux select-layout -t simplecasper:0 tiled
tmux send-keys -t simplecasper:0.2 source\ \~/.zshrc C-m
tmux send-keys -t simplecasper:0.2 simplecasper\ -l\ :debug\ run\ 2 C-m

tmux splitw -t simplecasper:0
tmux select-layout -t simplecasper:0 tiled
tmux send-keys -t simplecasper:0.3 source\ \~/.zshrc C-m
tmux send-keys -t simplecasper:0.3 simplecasper\ -l\ :debug\ run\ 3 C-m
